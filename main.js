...
[
    ...
    },
    {
      ...
      "body": "\nName: aaaaaaaaaaaaaaaaaaaaaaa\nProduct: Savings Account\nAccount No: aaaaaaaaaaaa\nApplication No: \nE-mail address: aaaaaaa.aaaaaaaaaaaaaaaaa\nMobile no: aaaaaaaaaa\nTelephone no: +aa--\nService Request(SR) No:\nDetails of  complaint: I want to open aaa. I tried online and submit button was disabled. So called customer care they told try in bank. Went to first bank aaaaaaaaaaaa they told not available and go to mg road, aaaaaaaaa. When I came to open here they told open in epran website. What is the purpose of having account in your bank incase you can&#aa;t help your customer. \n",
    ...
    if (singleItem) {
        $.each(singleItem, function(key, value) {
            ...
            var $tr = $('<tr>').append(
                ...
                $('<td class="' + (key == 'intent' ? 'field labels' : 'field') + '">').html("<pre>" + value + "</pre>")
            ).appendTo('#datatable');
        });
    }
    else {
