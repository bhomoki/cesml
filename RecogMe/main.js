...
var sigCanvas, context, answerHolder;
...
function initialize() {
    ...
    answerHolder = document.getElementById("answer");
    ...
    context.strokeStyle = '#5676B6';
    context.lineWidth = 10;
    context.lineCap = 'round'; // butt // round // square

    //$('#nums button').click(function() {teachNum($(this))});
    //$('#nums input').click(function() {teachNum($(this))});
